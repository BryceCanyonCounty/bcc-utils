...
- [Blips](#blips)
    - [Create a Blip](#create-a-blip)
    - [Get Raw Blip](#get-raw-blip)
    - [Delete a Blip](#delete-a-blip)
    - [Add Radius to Blip](#add-radius-to-blip)
- [Prompts](#prompts)
    - [Setup a Prompt Group](#setup-a-prompt-group)
    - [Register Prompt](#register-prompt)
    - [Display Prompt Group](#display-prompt-group)
    - [Handle Prompt Completion Events](#handle-prompt-completion-events)
    - [Handle Prompt Failure Events](#handle-prompt-failure-events)
    - [Delete Prompt](#delete-prompt)
    - [Toggle Prompt Visibility](#toggle-prompt-visibility)
- [Pedestrians (Peds)](#pedestrians-peds)
    - [Create Ped](#create-ped)
    - [Freeze Ped](#freeze-ped)
    - [Invincible Ped](#invincible-ped)
    - [Ped CanBeDamaged](#ped-canbedamaged)
    - [Set Ped Heading](#set-ped-heading)
    - [Set Ped Seeing Range](#set-ped-seeing-range)
    - [Set Ped Hearing Range](#set-ped-hearing-range)
    - [Set Ped Can Mount](#set-ped-can-mount)
    - [Add Ped to Group](#add-ped-to-group)
    - [Clear a ped task](#clear-a-ped-task)
    - [Get Task Status](#get-task-status)
    - [Follow to offset](#follow-to-offset)
    - [Follow to offset](#follow-to-offset)
    - [Set Ped Blip](#set-ped-blip)
    - [Give Ped Weapon](#give-ped-weapon)
    - [Set Ped Flee Attribute](#set-ped-flee-attribute)
    - [Set Ped Combat Attributes](#set-ped-combat-attributes)
    - [Set Ped Combat Style](#set-ped-combat-style)
    - [Clear Ped Combat Style](#clear-ped-combat-style)
    - [Attack Target](#attack-target)
    - [Remove Ped](#remove-ped)
    - [Get Ped](#get-ped)
- [Objects](#objects)
    - [Create Object](#create-object)
    - [Pickup Light](#pickup-light)
    - [Freeze](#freeze)
    - [Set Heading](#set-heading)
    - [Place On Ground](#place-on-ground)
    - [Set As Mission](#set-as-mission)
    - [Set As No Longer Needed](#set-as-no-longer-needed)
    - [Invincible](#invincible)
    - [Horse Jumpable](#horse-jumpable)
    - [Remove](#remove)
...
- [Destruction](#destruction)
    - [Get Destruction Object](#get-destruction-object)
    - [Check if the Destruction Object Exists](#check-if-the-destruction-object-exists)
    - [Reset State](#reset-state)
    - [Reset State](#reset-state)
- [Render](#render)
    - [WorldToScreen](#worldtoscreen)
    - [WorldToHud](#worldtohud)
...
- [Game Events](#game-events)
    ...
    - [DevMode](#devmode)
- [Audio Player Documentation](#audio-player-documentation)
- [Versioner Documentation](#versioner-documentation)
- [Discord Webhooks](#discord-webhooks)
    - [Send One Time Message](#send-one-time-message)
    - [Create Discord Re-usable instance](#create-discord-re-usable-instance)
